...
public class SmoothCameraFollow : MonoBehaviour {
    ...
    public float distnace = 4.0f;
    public float height = 1.0f;
    public float smoothLag = 0.2f;
    public float maxSpeed = 10.0f;
    public float snapLag = 0.3f;
    public float clamHeadpostionScreenSpace = 0.75f;
    ...
    void ApplySnapping(Vector3 targetCenter)
    {
        ...
        currentDistance = Mathf.SmoothDamp(currentDistance, distnace, ref velocity.z, snapLag);
    ...
    void ApplyPositionDamping( Vector3 targetCenter)
    {
        ...
        Vector3 offset = position - targetCenter;
        offset.y = 0;
        Vector3 newTargetPos = offset.normalized * distnace + targetCenter;
    ...
    void SetUpRotation(Vector3 centerPos, Vector3 headPos)
    {
        ...
        Vector3 relativeOffset = Vector3.forward* distnace +Vector3.down * height;
        ...
        Ray topRay = this.GetComponent<Camera>().ViewportPointToRay(new Vector3(.5f, clamHeadpostionScreenSpace, 1.0f));

        Vector3 centerRayPos = centerRay.GetPoint(distnace);
        Vector3 topRayPos = topRay.GetPoint(distnace);
